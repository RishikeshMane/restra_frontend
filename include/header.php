  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <!-- product end -->
        <!-- /Add User-->
        <li class="menu-item">
          <a href="#" class="has-chevron" data-toggle="collapse" data-target="#user" aria-expanded="false" aria-controls="user"> <span><i class="fas fa-user-friends fs-16"></i>Add Users </span>
          </a>
          <ul id="user" class="collapse" aria-labelledby="user" data-parent="#side-nav-accordion">
            <li class="menu-item">
              <a href="pages/users.html">Add Users</a>
            </li>
            <li> <a href="pages/userlist.html">Users List</a>
            </li>
          </ul>
        </li>
       <!-- /Add User end-->
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            <li class="dropdown-menu-header">
              <div id="mydiv"><h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Welcome, Anny Farisha</span></h6></div>
            </li>
            <li class="dropdown-divider"></li>
            ...
            <li class="dropdown-menu-footer">
              <a class="media fs-14 p-2"  onclick="gotologout()"> <span><i class="flaticon-shut-down mr-2"></i> Logout</span>
              </a>
            </li>
          </ul>
        </li>
